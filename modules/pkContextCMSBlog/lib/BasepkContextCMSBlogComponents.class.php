...
/**
 * Base actions for the pkBlogPlugin pkContextCMSBlog module.
 * 
 * @package     pkBlogPlugin
 * @subpackage  pkContextCMSBlog
 * @author      Your name here
 * @version     SVN: $Id: BaseComponents.class.php 12628 2008-11-04 14:43:36Z Kris.Wallsmith $
 */
abstract class BasepkContextCMSBlogComponents extends pkContextCMSBaseComponents
{
  ...
  public function executeNormalView()
  {
    ...
    {
      $this->pk_blog_post = Doctrine::getTable('pkBlogPost')->findOneBySlug($this->getRequest()->getParameter('p'));
    }
    else
    {
      $this->pk_blog_post = false;
    }
    
    // pkFeed::addFeed($request, pkUrl::addParams('pkBlog/feed', $feedParams));
  }
  ...
  public function buildQuery()
  {
    ...
    {
      $q = PluginTagTable::getObjectTaggedWithQuery('pkBlogPost', $this->getRequestParameter('tag'), null, array('nb_common_tag' => 1));
    }
    else
    {
    ...
    {
      $q = Doctrine::getTable('pkBlogPost')->addSearchQuery($q, $this->getRequestParameter('search'));
    }
